...
namespace Runtime
{
    ...
    {
        private static Eddy privateInstance;

        public static Eddy instance
        {
            get
            {
                if (privateInstance == null) privateInstance = FindFirstObjectByType<Eddy>();
